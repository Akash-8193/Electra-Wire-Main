...
const BuiltOnTrustSection = () => {
  return (
    <div className="w-full gsap-fade-in -mt-12 @tablet:-mt-20 -mb-12 @tablet:-mb-20 relative z-20 pointer-events-none" id="built-on-trust">
        ...
        <div className="relative overflow-hidden bg-transparent">
          <div className="relative mx-auto max-w-[1536px] px-6 py-0">
            <div className="flex flex-col items-center gap-2">
              <h2
                className="[font-family:var(--typography-font-family)] text-center font-bold tracking-tight text-[#060603] -mt-4 @tablet:-mt-8"
                style={{
