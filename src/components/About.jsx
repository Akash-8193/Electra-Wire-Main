    ...
    return (
        <main ref={rootRef}>
            ...
            <div className="w-full" id="legacy-excellence">
                <section className="w-full bg-white relative py-16 md:py-24" style={{ contain: 'layout style paint' }}>
                    <div className="mx-auto max-w-[1536px] px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <div className="flex flex-col gap-10">
                                ...
                                <div className="bg-[#D92323] rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl">
                            ...
                            <div className="relative h-full min-h-[400px] md:min-h-[500px] lg:min-h-[700px] w-full rounded-[2rem] overflow-hidden shadow-2xl">
                                <img
                ...
                <section className="w-full" style={{ contain: 'layout style paint' }}>
                    <div className="relative">
                        ...
                        <div className="relative mx-auto max-w-[1536px] px-6 flex w-full flex-col gap-4 py-16 md:py-24 md:gap-6 items-start text-left" style={{ zIndex: '10' }}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mt-8 md:mt-12">
                                <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100 flex flex-col gap-5 transition-transform hover:-translate-y-1">
            ...
            <div className="w-full" id="our-team">
                <section className="w-full" style={{ contain: 'layout style paint' }}>
                    <div className="relative">
                        <div className="absolute inset-0" style={{ borderRadius: 'inherit', background: '#FFF8E4' }}></div>
                        <div className="relative mx-auto max-w-[1536px] px-6 flex flex-col gap-8 py-16 md:py-24 md:gap-16" style={{ zIndex: '10' }}>
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col gap-4 md:gap-8 lg:flex-row lg:justify-between">
                            ...
                            <div className="grid grid-cols-1 gap-10 md:gap-8 lg:grid-cols-2">
                                <div className="flex flex-col gap-6 md:flex-row md:gap-6 lg:flex-row lg:gap-8">
                                    <div className="shrink-0 md:w-50">
                                        <div className="relative w-full rounded-3xl overflow-hidden h-75 md:h-50 md:w-50">
                                            <img alt="Akash Sharma, Founder" fetchPriority="auto" loading="lazy" decoding="async" data-nimg="fill" className="h-75 md:h-50 md:w-50" style={{ position: 'absolute', height: '100%', width: '100%', left: '0', top: '0', right: '0', bottom: '0', objectFit: 'cover', objectPosition: '50% 50%', color: 'transparent', transformOrigin: '50% 50%', transform: 'scale(1)' }} sizes="(max-width: 640px) 100vw, 200px" src="/_next/917af533-177d-4e38-9a29-47b2d3cce5b2-xlgAzaO6u49l1NphooJ07DydKgudZM3165.png" />
                                        </div>
                                    </div>
            ...
            <div className="w-full" id="client-testimonials">
                <section className="w-full" style={{ contain: 'layout style paint' }}>
                    <div className="relative">
                        <div className="absolute inset-0" style={{ borderRadius: 'inherit', background: '#FFF8E4' }}></div>
                        <div className="relative mx-auto max-w-[1536px] px-6 flex flex-col gap-8 py-16 md:py-24" style={{ zIndex: '10' }}>
            ...
            <div className="w-full" id="faqs">
                <section className="w-full" style={{ contain: 'layout style paint' }}>
                    <div className="relative" style={{ paddingBottom: '488px' }}>
                        ...
                        <div className="relative mx-auto max-w-[1536px] px-6 flex flex-col gap-12 py-16 md:py-24" style={{ zIndex: '10' }}>
                            ...
                            <div className="flex flex-col gap-12 lg:grid lg:grid-cols-2 lg:items-start lg:gap-16">
                                            ...
                                            <div key={index} data-state="closed" data-orientation="vertical">
                                                <div style={{ '--bg-color': 'rgba(0%, 0%, 0%, 0.04764)' }} className="bg-(--bg-color) mb-4 p-6 rounded-3xl">
                                                    <h3 data-orientation="vertical" data-state="closed">
                                                        <button type="button" aria-controls={contentId} aria-expanded="false" data-state="closed" data-orientation="vertical" id={triggerId} className="faq-button flex w-full cursor-pointer items-center gap-4 text-left transition-colors duration-200 focus:outline-none group" data-radix-collection-item="">
                                ...
                                <div className="hidden lg:block rounded-3xl sticky top-0 aspect-square overflow-hidden">
